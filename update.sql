...
CREATE TABLE tb_video_metadata(
    video_metadata_id SERIAL NOT NULL,
    item_id integer,
    ...
    CONSTRAINT tb_video_metadata_item_id_fkey FOREIGN key(item_id) REFERENCES tb_items(item_id)
);
...
COMMENT ON COLUMN tb_video_metadata.created_ts IS '서버 저장 시간';
COMMENT ON COLUMN tb_video_metadata.file_ext IS '파일 확장자';
